...
const HomePage: React.FC<HomePageProps> = ({
  ...
  const handleMockGoogleSignIn = async () => {
    ...
    setIsAuthLoading(true);
    try {
      await onLogin('google_user@gmail.com', 'google_sola_assistant_mock_password');
    } catch (err) {
        ...
        <div className="w-full max-w-[420px] relative z-10">
          ...
          <div className="bg-white dark:bg-zinc-900/60 border border-zinc-200/80 dark:border-zinc-800/80 rounded-3xl p-8 shadow-xl backdrop-blur-md">
            ...
            <div className="relative flex py-4 items-center">
              <div className="flex-grow border-t border-zinc-100 dark:border-zinc-850"></div>
              <span className="flex-shrink mx-4 text-zinc-400 dark:text-zinc-500 text-[10px] font-bold tracking-wider">OR</span>
              <div className="flex-grow border-t border-zinc-100 dark:border-zinc-850"></div>
            </div>
            ...
            <button
              ...
              disabled={isAuthLoading}
              className="w-full py-2.5 bg-slate-50 hover:bg-slate-100 dark:bg-zinc-850 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-300 font-bold text-xs rounded-xl transition-all border border-zinc-200/50 dark:border-zinc-800 flex items-center justify-center gap-2"
            >
